...
class Facebook
{
    ...
    {
        $previousPageUrl = $this->toObject()->paging->previous;
        $this->response = $this->client->get($previousPageUrl);
    ...
    {
        $nextPageUrl = $this->toObject()->paging->next;
        $this->response = $this->client->get($nextPageUrl);
